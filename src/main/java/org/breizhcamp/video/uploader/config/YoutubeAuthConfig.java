 ...
 */
@Configuration
public class YoutubeAuthConfig {
	...
	public GoogleAuthorizationCodeFlow ytAuthFlow() throws IOException, GeneralSecurityException {
		...
		GoogleClientSecrets secrets = GoogleClientSecrets.load(jacksonFactory(),
				new InputStreamReader(YoutubeAuthConfig.class.getResourceAsStream("/oauth-google.json")));
	 ...
	 */
	@Bean
	public Credential ytCredential(GoogleAuthorizationCodeFlow ytAuthFlow) throws IOException {
